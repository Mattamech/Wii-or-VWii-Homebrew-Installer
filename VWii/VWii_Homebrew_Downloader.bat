...
pause
cd C:\VWii_Homebrew
curl https://raw.githubusercontent.com/Mattamech/Wii-or-VWii-Homebrew-Installer/master/VWii/VWii_Homebrew_Installer.txt?token=AKIPMQPYNB5EQ4FALB5G3YS6TG3E6 --output VWii_Homebrew_Installer.txt
