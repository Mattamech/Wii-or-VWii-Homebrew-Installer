...
pause
cd C:\VWii_Homebrew
curl https://raw.githubusercontent.com/Mattamech/Wii-or-VWii-Homebrew-Installer/master/VWii/VWii_Homebrew_Installer.txt?token=AKIPMQN3WPZSQ7QP6WOEU4K6TG34E --output VWii_Homebrew_Installer.txt
