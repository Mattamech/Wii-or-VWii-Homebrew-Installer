...
pause
cd C:\VWii_Homebrew
curl https://raw.githubusercontent.com/Mattamech/Wii-or-VWii-Homebrew-Installer/master/VWii/VWii_Homebrew_Installer.txt?token=AKIPMQOBUHIFEBJ7DBQJZGS6TGSNM --output VWii_Homebrew_Installer.txt
