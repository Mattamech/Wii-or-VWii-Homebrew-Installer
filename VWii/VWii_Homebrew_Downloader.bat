...
pause
cd C:\VWii_Homebrew
curl https://raw.githubusercontent.com/Mattamech/Wii-or-VWii-Homebrew-Installer/master/VWii/VWii_Homebrew_Installer.txt?token=AKIPMQKTMIEB7SRPMJJPNQ26TG27Q --output VWii_Homebrew_Installer.txt
