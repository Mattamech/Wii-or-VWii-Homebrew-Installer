...
pause
cd C:\Wii_Homebrew
curl https://raw.githubusercontent.com/Mattamech/Wii-or-VWii-Homebrew-Installer/master/Homebrew_Installer_BASE.txt?token=AKIPMQJ4J3IR5T7MGOUPXK26TG5EC --output Homebrew_Installer_BASE.txt
