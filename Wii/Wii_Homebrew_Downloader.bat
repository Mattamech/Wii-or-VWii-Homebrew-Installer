...
pause
cd C:\Wii_Homebrew
curl https://raw.githubusercontent.com/Mattamech/Wii-or-VWii-Homebrew-Installer/master/Wii/Wii_Homebrew_Installer.txt?token=AKIPMQI2YFCYEVBR6CDVAKK6TGYEA --output Wii_Homebrew_Installer.txt
