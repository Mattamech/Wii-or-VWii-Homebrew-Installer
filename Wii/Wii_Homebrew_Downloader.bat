...
pause
cd C:\Wii_Homebrew
curl https://raw.githubusercontent.com/Mattamech/Wii-or-VWii-Homebrew-Installer/master/Wii/Wii_Homebrew_Downloader.bat?token=AKIPMQMLTG4X5K4TS2EVS6S6TGTNU --output Wii_Homebrew_Installer.txt
